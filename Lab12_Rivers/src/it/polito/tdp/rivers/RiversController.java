...
public class RiversController {
    ...
    void doSimula(ActionEvent event) {
    	...
    	try {
    		...
    		if(k<=0) {
    			txtResult.setText("Errore inserimento dati!");
    			return;
    		}
    ...
    void doPopola(ActionEvent event) {
    	...
    	txtStartDate.setText(model.getRisultati(r).getStartDate().toString());
    	txtEndDate.setText(model.getRisultati(r).getEndDate().toString());
    	txtNumMeasurements.setText(String.format("%d",model.getRisultati(r).getNumMeasurement()));
    	txtFMed.setText(String.format("%f", model.getRisultati(r).getAvgFlow()));
